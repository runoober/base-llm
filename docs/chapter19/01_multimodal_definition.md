...
<p align="center">
  <img src="./images/19_1_1.png" width="90%" alt="多模态交互示意图" />
  <br />
...
<p><em>表 19-1 多模态机器学习五大挑战（基于 CMU & Mercari 观点）</em></p>
...
<p align="center">
  <img src="./images/19_1_2.png" width="80%" alt="逆水寒智能 NPC" />
  <br />
...
<p align="center">
  <img src="./images/19_1_4.png" width="80%" alt="Unitree H1" />
  <br />
  <em>图 19-4 Unitree H1</em>
</p>

（4）**科学与医疗探索**：在对数据精度与隐私要求极高的专业领域，多模态技术也在辅助专家突破人类认知的边界。**智慧医疗**整合**医学影像**（CT/MRI）、**电子病历**（文本）与**生化指标**（结构化数据）辅助癌症筛查或病情预判，该领域的难点在于极低的容错率，必须严格**抑制幻觉**并引入人类专家复核（HITL）与可追溯证据机制。还有**跨学科科研**利用多模态模型分析卫星图像（天文/地理）、预测蛋白质结构（生物），或通过产学研结合解决实验室模型向工业界落地的鸿沟。
